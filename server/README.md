...
- O usário dever poder recuperar sua senha informado o seu e-mail;
...
- O usuário precisa de confirmar a nova senha ao resetar sua senha;
...
- Para atualizar sua senha, o usuário precisa de confirmar a nova senha;
